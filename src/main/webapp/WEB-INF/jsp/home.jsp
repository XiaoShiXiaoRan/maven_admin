...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <%--遍历第一层菜单  pid=0--%>
            <c:forEach items="${requestScope.listMenu}" var="menuLvl1">
                <li>
                    <a href="javascript:;">
                    ...
                    <ul class="sub-menu">
                       ...
                       <c:forEach items="${menuLvl1.treeList}" var="menuLvl2">
                           <li>
                               <a data-title="${menuLvl2.menuName}" data-url="${ctx.concat(menuLvl2.menuUrl)}" class="a-menu">
                                   <i class="iconfont">&#xe6a7;</i>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='${ctx}/home/welcome' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
